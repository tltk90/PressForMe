...
public class MainApp extends javax.swing.JFrame {
    ...
    public MainApp() {
        ...
        keysArea.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            ...
            private String getLine(int line) throws BadLocationException{
                return keysArea.getText().substring(keysArea.getLineStartOffset(line), keysArea.getLineEndOffset(line));
            }
        }
        );
    ...
    private void initComponents() {
        ...
        keysAreaPane = new javax.swing.JScrollPane();
        keysArea = new javax.swing.JTextArea();
        ...
        keysArea.setColumns(20);
        keysArea.setRows(5);
        keysArea.setFocusable(false);
        keysAreaPane.setViewportView(keysArea);
        ...
        set.add(keysAreaPane, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        set.add(jPanel1, gridBagConstraints);
    ...
    private void multiBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_multiBtnActionPerformed
        ...
        keysArea.append(String.format("(%d)", m));
    ...
    private Map<String, Integer> text2key;
    ...
    private javax.swing.JTextArea keysArea;
    private javax.swing.JScrollPane keysAreaPane;
